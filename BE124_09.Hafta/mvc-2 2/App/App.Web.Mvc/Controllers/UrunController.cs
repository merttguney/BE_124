...
namespace App.Web.Mvc.Controllers
{
    public class UrunController : Controller
    {
        ...
        [HttpGet]
        public IActionResult Add() // bunun görevi Ürün ekleme formunu açmak
        {
            return View();
        }

        [HttpPost]
        public IActionResult Add([FromForm] Product product) // gerçekten ürün ekleme işini bu action yapıyor
        {
